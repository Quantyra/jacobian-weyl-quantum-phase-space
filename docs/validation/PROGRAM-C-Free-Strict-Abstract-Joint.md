...
### 5e. Theorem J7 — full-\(\psi\) abstract \(C^*\) split
...
**Theorem J7-C.** Full-ψ-BT-Envelope is a well-defined unital \(C^*\) carrying position content of \(\psi\) and momentum-form content via non-SA (for \(j=1\)) contractions — no Hom/unitary-image/SA-extension axioms.
...
| Full-ψ-BT-Envelope (\(\Phi_0(C_b)+Z(\overline{H_j})\)) | **CONSTRUCT** | **J7-C** |
...
4. **No claim beyond what is proved here:**  
   ...
   - J7-C constructs BT-Envelope; J7 kills SA-CFC recovery via J6; J7-O (CP-Weyl-C\*) remains open; Joint-Form-Core is form-level only.
