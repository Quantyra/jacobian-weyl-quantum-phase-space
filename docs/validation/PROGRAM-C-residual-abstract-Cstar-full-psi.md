...
|------|-----------------|---------|
| **Full-ψ-BT-Envelope** | concrete \(C^*\) in \(B(H)\) generated by \(\Phi_0(C_b(Q))\) and **bounded transforms** of the closed minimal dual momenta \(\overline{H_j}\) — no SA extension choice, no unitary Stone image, no \(*\)-hom of full CCR | **CONSTRUCT (J7-C)** |
...
**Why BT-Envelope is full-\(\psi\), not Diag-CP.**  
Diag-CP-Φ₀ encodes positions inside \(M\) and kills nonzero Fourier modes of \(U(s)\). It does **not** carry dual-momentum content. BT-Envelope adjoins the bounded transforms \(Z_j\) of all three minimal dual momenta — the standard bounded avatars of the form-level Joint-Form-Core generators — so both position masa content and momentum-form content sit in one concrete \(C^*\) algebra.
...
**Non-claims.** No Joint-Stone success. No full channel on \(B(H)\). No gates/advantage. No dual-\(F\) translations (T4). Diag-CP is **not** relabeled as full-\(\psi\). No A001 endorsement work. No claim that every abstract CP extension of \(\psi\) fails.
...
The **BT-envelope** of full \(\psi\) is the unital \(C^*\)-algebra
\[
\mathfrak{A}_\psi
\;:=\;
C^*\Bigl(
...
**Proof.**  
Assume \(\Phi\) is Full-ψ-CFC-SA-1. By Lemma J7.6 it yields a Unitary-Image-CP-1 package. Theorem J6 says no such package exists. \(\square\)
...
| **Full-ψ-BT-Envelope** (concrete \(C^*\) from \(\Phi_0(C_b)\) + \(Z(\overline{H_j})\)) | **CONSTRUCT** | **J7-C** |
| **Full-ψ-CFC-SA-1** / Cayley-Unitary-1 | **OBSTRUCT** | **J7** |
...
2. Full-ψ-BT-Envelope is **not** a quantum channel on \(B(H)\), not a Stinespring instrument, and not a gate.  
...
7. J7 does **not** weaken J2–J6: those packs remain NO-GO on their stated axioms; J7 names the CFC-SA specialization.  
