...
| Gate | Primary dossier |
|------|-----------------|
| G0-seed | `D0-seed-validation-dossier.md` |
| G0-family | `D0-family-pilot-dossier.md` |
| G1 | `data/atlas/` |
| G2 | `G2-poisson-A001-dossier.md` |
| G3 | `G3-weyl-A001-dossier.md` |
| G4 | `G4-domains-CCR-A001-dossier.md`, `G4-PHASE1-CLOSEOUT.md`, `G4-H0-H2-deficiency-bounds.md`, `G4-strong-CCR-extensions-A001.md` |
| G5 | `G5-completion-degree-A001-dossier.md`, `PHASE3-levels-DE-A001.md` |
| G6 | `G6-CP-dilation-A001-dossier.md` |
| G7 | `G7-semigroup-index-A001-dossier.md` |
| Phase 2 | `PHASE2-family-genericity-A001.md` |
