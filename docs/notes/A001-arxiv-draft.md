...
**Errata.** v0.2.2 pair \((0,\infty)\) **withdrawn**. v0.3.0 interior \(s\)-cutoffs **withdrawn**. v0.3.3: whole maximal orbits (8.2)--(8.3).
...
What the paper does **not** establish is equally important. We do not claim discovery of \(F\); unitary gates, channels, or computational advantage; essential-self-adjointness failure for \(H_0\) or \(H_2\); strong CCR after extensions; or a preferred physical boundary condition at the incomplete ends. The Lean companion covers the bounded canonical-core Theorems E--F, exact Hilbert-basis cardinality of the closed adjoint eigenspaces, the specific `H_X1_min` von Neumann classification, and existence of at least two distinct extension witnesses. It does not cover the paper's backward-wall construction, exact algebraic/Hamel rank, a preferred extension, an arbitrary-operator theorem, exact extension cardinality, or the stronger paper-grade infinitely-many/continuum and algebraic-selection consequences.
...
3. Lean formalization of the paper-grade analytic backward-wall construction and any stronger extension-cardinality or algebraic-selection consequence; the specific canonical-minimal classification, at-least-two result, and exact Hilbert-basis cardinal are covered, while exact algebraic/Hamel rank is not claimed.
...
[6] D. E. Fredriksen, *exotic-ccr-lean: Lean 4 Gate-0 certificates*, https://github.com/Quantyra/exotic-ccr-lean (`ExoticCCR.theoremF`, `hilbertDeficiencyIndex_X1_eq_aleph0`, `theoremFVonNeumannClassification`, and `theoremF_exists_two_distinct_selfAdjointExtensions`, SHA ff50f4a2a312591c2e5b26e71eb390ade9164b34).
