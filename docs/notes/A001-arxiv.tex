...
\texttt{f1fe83785add60ccc5f012b51e7576aab5627a74} (proposed, untagged, under review) the artifact further proves
...
(algebraic/Hamel rank) and has lower bounds only.

The backward-wall
propositions and von Neumann extension multiplicity/classification remain
paper-grade and are not claimed as Lean-covered.
...
\section{Non-claims}
No unitary gate, channel, CP map, or computational advantage. No preferred physical extension. No claim that all quantization routes fail. Discovery of \(F\) not claimed. Lean: bounded canonical-core Theorems E--F and the exact Hilbert-basis cardinal result are covered at the updated SHA. The algebraic \texttt{standardDeficiencyIndex}/\texttt{Module.rank} has lower bounds only; the paper-grade backward-wall construction and von Neumann extension multiplicity/classification remain outside Lean coverage. No theorem-level dual-flow strong CCR obstruction in this note.
...
\filepath{hilbertDeficiencyIndex\_X1\_eq\_aleph0} at SHA
f1fe83785add60ccc5f012b51e7576aab5627a74 (untagged review). Both standard
...
value is not claimed. Extension multiplicity/classification and paper
backward-wall construction are not Lean-covered.
\end{thebibliography}
\end{document}
