...
(n_+,n_-)=(\infty,\infty)
\]
for \(H=-iX_1\). Infinitely many self-adjoint extensions exist; the core algebraic CCR/Poisson data alone do not distinguish among them. No gates, channels, computational advantage, or seed discovery claim. Companion code release \textbf{v0.3.5-submit}.
\end{abstract}

\noindent\textbf{MSC 2020:} 47B25, 81S05, 14R15, 37C10, 53D17.\\
\textbf{Software:} v0.3.5-submit; concept DOI 10.5281/zenodo.21474351.\\
...
On 19--20 July 2026, Levent Alp\"oge announced an explicit polynomial map \(F:\mathbb{C}^3\to\mathbb{C}^3\) with \(\det DF\equiv-2\) and a three-point collision, crediting the system Fable~\cite{Alpoge2026,UlamJacobian,SpeyerJC2026}. \textbf{We do not claim discovery of \(F\).} We re-verified the seed identities by CAS and recorded a Lean 4 formalization of those finite algebraic checks~\cite{FredriksenLean}.
...
D.~E.~Fredriksen, EXOTIC-CCR A001 companion code and CAS certificates, GitHub \texttt{Quantyra/jacobian-weyl-quantum-phase-space}, release \texttt{v0.3.5-submit}, concept DOI 10.5281/zenodo.21474351.

\bibitem{FredriksenLean}
D.~E.~Fredriksen, \texttt{exotic-ccr-lean}, GitHub \texttt{Quantyra/exotic-ccr-lean} (Lean 4 formalization of the seed identities and dual-matrix algebra for this companion).
\end{thebibliography}
\end{document}
