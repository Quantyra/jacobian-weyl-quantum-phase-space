...
\texttt{8a08cf4c5803a19a5ae3dd9e980734d4595d636b} (proposed, untagged, under review) the artifact further proves
...
finite-dimensional, the bounded reading of $(n_+,n_-)=(\infty,\infty)$. The
...
backward-wall propositions, the exact countable index value as a cardinal, and
extension multiplicity remain paper-grade and are not claimed as Lean-covered.
...
\section{Non-claims}
No unitary gate, channel, CP map, or computational advantage. No preferred physical extension. No claim that all quantization routes fail. Discovery of \(F\) not claimed. Lean: bounded canonical-core Theorems E--F only as described above; the exact cardinal index, extension multiplicity, and backward-wall construction remain paper-grade. No theorem-level dual-flow strong CCR obstruction in this note.
...
Theorem F supplement: `ExoticCCR.theoremF` at SHA
8a08cf4c5803a19a5ae3dd9e980734d4595d636b (untagged review). Both standard
adjoint eigenspaces are not finite-dimensional; the exact cardinal index,
extension multiplicity, and paper backward-wall construction are not
Lean-covered.
\end{thebibliography}
\end{document}
