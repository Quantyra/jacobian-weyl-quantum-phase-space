...
tag v0.1.2-theorem-c-algebra (commit c9bd0d2),
\url{https://github.com/Quantyra/exotic-ccr-lean/releases/tag/v0.1.2-theorem-c-algebra}
(Lean~4 formalization of the seed identities, dual-matrix algebra, Piola row
divergence, and full dual-field commutation on polynomials).
\end{thebibliography}
\end{document}
