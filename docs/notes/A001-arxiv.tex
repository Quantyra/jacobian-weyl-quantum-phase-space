...
\textbf{Software:} v0.3.6-submit; concept DOI
\url{https://doi.org/10.5281/zenodo.21474351}
(project-level; version DOI pending Zenodo ingest).\\
...
tag v0.1.3-theorem-c-weyl (commit ef4ee2f),
\url{https://github.com/Quantyra/exotic-ccr-lean/releases/tag/v0.1.3-theorem-c-weyl}
(Lean~4 formalization of the seed identities, dual-matrix algebra, Piola row
divergence, full dual-field commutation, and the polynomial Weyl endomorphism
\(\psi\)).
\end{thebibliography}
\end{document}
