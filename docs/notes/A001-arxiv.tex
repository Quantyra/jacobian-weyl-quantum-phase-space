...
\texttt{30df8bcd310cab7a2c53d18500fcf847f1e284d2} (proposed, untagged, under review) the artifact further proves
...
backward-wall propositions, equality $n_\pm=\operatorname{aleph0}$, and extension
multiplicity/classification remain paper-grade and are not claimed as
Lean-covered.
...
\section{Non-claims}
No unitary gate, channel, CP map, or computational advantage. No preferred physical extension. No claim that all quantization routes fail. Discovery of \(F\) not claimed. Lean: bounded canonical-core Theorems E--F only as described above; equality \(n_\pm=\operatorname{aleph0}\), extension multiplicity/classification, and backward-wall construction remain paper-grade. No theorem-level dual-flow strong CCR obstruction in this note.
...
untagged review SHA a6bb091 (bounded Theorem E),
\url{https://github.com/Quantyra/exotic-ccr-lean/releases/tag/v0.1.4-theorem-d-incomplete}
...
Theorem F supplement: \texttt{ExoticCCR.theoremF} and
\texttt{aleph0\_le\_standardDeficiencyIndex\_X1} at SHA
30df8bcd310cab7a2c53d18500fcf847f1e284d2 (untagged review). Both standard
adjoint eigenspaces are not finite-dimensional, and
\(\operatorname{Cardinal.aleph0}\le n_+\) and
\(\operatorname{Cardinal.aleph0}\le n_-\). Equality
\(n_\pm=\operatorname{aleph0}\), extension multiplicity/classification, and
paper backward-wall construction are not Lean-covered.
\end{thebibliography}
\end{document}
