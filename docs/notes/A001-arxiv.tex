...
\textbf{Software:} v0.3.7-theorem-e (proposed, untagged); concept DOI
...
The companion Lean artifact at SHA \texttt{a6bb091} proves the bounded canonical-core
declaration \texttt{ExoticCCR.theoremE}: the minimal transport core for X1 is not
essentially self-adjoint via a constructed weak minus-i witness. The
deficiency-index value (infinity,infinity), extension multiplicity, and full
Theorem~F remain paper-grade and are not claimed as Lean-covered.
...
GitHub Quantyra/jacobian-weyl-quantum-phase-space, release v0.3.6-submit,
