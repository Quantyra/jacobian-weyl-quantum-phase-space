...
| Tag / release | prior freeze `v0.2.2-b001-draft` @ `61bf3da` **superseded for B automorphism language** (tags frozen; do not move). Pending after gate: e.g. `v0.2.3-b001-draft` on new SHA |
...
| Tag / release | prior freeze `v0.3.2-c001-companion` @ `61bf3da` (C content unchanged this erratum; do not move tag). Pending after gate only if dual-tagged with B: e.g. `v0.3.3-c001-companion` same SHA, else leave C pin |
