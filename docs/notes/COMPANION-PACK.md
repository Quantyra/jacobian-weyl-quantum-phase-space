...
| Marker | [C001-FREEZE-v0.1.md](C001-FREEZE-v0.1.md) (content = v0.6, adversarial PASS) |
...
| Claims | Algebraic \*-SOS; correspondence; C0/Bogoliubov NO-GO; Koopman position **CONSTRUCT**; J2 Joint-Stone-Canonical NO-GO; J3 full-triple Joint-Stone NO-GO (G4); **J4 Joint-Stone-Hom-1 NO-GO**; Joint-Form-Core **CONSTRUCT**; Joint-Form-ESS-1 **OBSTRUCT** |
| Joint notes | [`PROGRAM-C-Free-Strict-Abstract-Joint.md`](../validation/PROGRAM-C-Free-Strict-Abstract-Joint.md), [`PROGRAM-C-residual-J4-Joint-Stone-Hom.md`](../validation/PROGRAM-C-residual-J4-Joint-Stone-Hom.md) |
| Withdrawn | Free-Strict-Regular-v2 |
| Open | **Mere-CP** (non-multiplicative) choice-dependent Joint-Stone + \(\Phi_0\); abstract C\* envelope without Hom/Stone |
...
3. Completions of \(\psi\): C001 `v0.3.0-c001-companion` tag (v0.6)  
