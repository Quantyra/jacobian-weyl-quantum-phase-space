...
| Tag / release | [v0.2.3-b001-draft](https://github.com/Quantyra/jacobian-weyl-quantum-phase-space/releases/tag/v0.2.3-b001-draft) @ `45e7d53` |
...
| Gate status | **Aggregate PASS** at `45e7d53` / `v0.2.3-b001-draft` (proof · non-claims · package) |
...
| Tag / release | [v0.3.3-c001-companion](https://github.com/Quantyra/jacobian-weyl-quantum-phase-space/releases/tag/v0.3.3-c001-companion) @ `45e7d53` |
...
| Gate status | **Aggregate PASS** at `45e7d53` / `v0.3.3-c001-companion` (proof · non-claims · package) |
