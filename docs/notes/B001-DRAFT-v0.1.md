...
> not identify this corrected PDF.
...
**Historical Aggregate PASS** at `45e7d53` (`v0.2.3-b001-draft`):
proof PASS · non-claims PASS · package PASS. That review does not approve the
current cross-companion correction.
