...
- B001 v0.7 real-poly auto-language erratum (post-`61bf3da` main): **C001 math content untouched**; dual freeze tags `v0.2.2-b001-draft` / `v0.3.2-c001-companion` @ `61bf3da` are **immutable historical pins package-superseded** (do not move; do not cite as current package). Pending dual successors after gate: `v0.2.3-b001-draft` + `v0.3.3-c001-companion`. **No Aggregate PASS.**
