...
| **C001** completions of \(\psi\) (v0.7) | [C001-cp-correspondence-arxiv.pdf](docs/notes/C001-cp-correspondence-arxiv.pdf) | [v0.3.0-c001-companion](https://github.com/Quantyra/jacobian-weyl-quantum-phase-space/releases/tag/v0.3.0-c001-companion) | Koopman CONSTRUCT; J2–J5 Stone/Hom/CP-1 NO-GOs; Joint-Form-Core CONSTRUCT; CP without Stone OPEN |
